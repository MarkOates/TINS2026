...
TEST(AllegroFlare_Testing_Comparison_DialControl_GameProgressAndStateInfoTest,
   PrintTo__with_an_AllegroFlare_GameProgressAndStateInfo__will_output_as_expected)
{
   std::stringstream ss;
   DialControl::GameProgressAndStateInfo object;
...
{
   DialControl::GameProgressAndStateInfo object;
   DialControl::GameProgressAndStateInfo other_object;
