...
TEST(TINS2026_Game_Configurations_MainTest, can_be_created_without_blowing_up)
{
   TINS2026::Game::Configurations::Main main_configuration;
}


TEST(TINS2026_Game_Configurations_MainTest, load_level_by_identifier__will_not_blow_up)
{
   TINS2026::Game::Configurations::Main main_configuration;
