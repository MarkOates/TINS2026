...
TEST(AllegroFlare_Testing_Comparison_TINS2026_GameProgressAndStateInfoTest,
   PrintTo__with_an_AllegroFlare_GameProgressAndStateInfo__will_output_as_expected)
{
   std::stringstream ss;
   TINS2026::GameProgressAndStateInfo object;
...
{
   TINS2026::GameProgressAndStateInfo object;
   TINS2026::GameProgressAndStateInfo other_object;
