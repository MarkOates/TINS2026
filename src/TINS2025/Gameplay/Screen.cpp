...
void Screen::game_event_func(AllegroFlare::GameEvent* game_event)
{
   ...
   else if (game_event->is_type("document_giraffe_event"))
   {
      ...
      document_animal_type(TINS2025::Entity::Type::ENTITY_TYPE_GIRAFFE);
   }
   else if (game_event->is_type("document_goat_event"))
   {
      ...
      document_animal_type(TINS2025::Entity::Type::ENTITY_TYPE_GOAT);
   }
   ...
   result.set_nodes({
      ...
      { "zoo_mechanic__after_wind", new AllegroFlare::DialogTree::Nodes::Interparsable(LOTTIE, {
         ...
         //}, { { "plant spawn", new AllegroFlare::DialogTree::NodeOptions::GoToNode("start_plant_reveal"), 0 } }
            ...
            //"And, if I can't write stuff down... (em)I'll get overwhelmed from all the excitement(/em).",

            //"And I have to stay focused...",
            "If I get too close to the animals without being able to write stuff down, I'll get (em)overstimulated(/em)!",
            "Writing notes is how I keep my mind clear.",
            "Deep breaths...",
            "*pfoo* *pfoo*",
            //"If I find the pages, approach the animals!",
            //"That's the only way to keep my cool."
         }, { { "Exit", new AllegroFlare::DialogTree::NodeOptions::ExitDialog(), 0 } }
      )},
      { "zoo_wind_blows_notebook", new AllegroFlare::DialogTree::Nodes::Interparsable(NARRATOR, {
            ...
            "It was so fierce, all of Lottie's blank pages soared into the air and were spread all over the zoo!",
            //"",
            //"Oooh! And there's the first exhibit! The Red Panda!",
            //"EEEeeee!! It's so cute I can't even stand it!",
            //"Wait... oh no! My notebook!",
