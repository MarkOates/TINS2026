...
export_options.horizontalScale = 200;  // Scale to 75%
export_options.verticalScale = 200;    // Scale to 75%
...
//var file_path = doc.fullName.parent.fsName + "/" + file_name + "-48x48-test.png";

// Hard-coded path
var file_path = "/Users/markoates/Repos/TINS2026/bin/data/bitmaps/" + file_name + "-2x.png";
...
// Notify the user
alert("SUCCESS! \n\nArtboard exported as PNG at: " + file_path);
